...
namespace SavorChef.Backend.Migrations
{
    ...
    [Migration("20230604205637_RenameFavoriteRecipesTable")]
    partial class RenameFavoriteRecipesTable
    {
            ...
            modelBuilder.Entity("RecipeEntityUserEntity", b =>
                {
                    ...
                    b.Property<int>("UsersThatAddedToFavoritesId")
                        .HasColumnType("integer")
                        .HasColumnName("UserId");

                    b.HasKey("FavoriteRecipesId", "UsersThatAddedToFavoritesId");

                    b.HasIndex("UsersThatAddedToFavoritesId");
            ...
            modelBuilder.Entity("RecipeEntityUserEntity", b =>
                {
                    ...
                    b.HasOne("SavorChef.Backend.Data.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UsersThatAddedToFavoritesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
